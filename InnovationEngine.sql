...
--
-- Host: localhost:8889
-- Generation Time: Oct 26, 2024 at 07:24 PM
...
(39, 'Circlight', 'The traditional student pick-up process in Saudi schools is a laborious and potentially hazardous experience for both parents and children. Parents are required to wait in line to announce their arrival over the school\'s microphone, while children must remain vigilant and attentive to the announcements, often amidst a crowded and noisy environment. This antiquated system can lead to increased anxiety and fear in children, as well as pose a risk to their safety due to the crowdedness at the school entrance and surrounding areas. Furthermore, working parents often find this process to be time-consuming and inconvenient, highlighting the need for a more efficient and secure solution to the traditional student pick-up process in Saudi schools is the development of a mobile application, Circlight, which utilizes Internet of Things (IoT) technology and smart bracelets to facilitate a more efficient, secure, and convenient experience for both parents and children.\r\n\r\n', 'iot,bracelet,smart bracelet,children,children pickup,iot,parent,parent pickup,school pickup,school', '-', 'Management System'),
...
('aabeer@KSU.EDU.SA', 'Abeer Aldayel', '1', NULL, NULL, 'computational social science,natural language processing', 'Available', ''),
...
('alyahya@KSU.EDU.SA', 'Maha AlYahya', '1', 'Artificial Intelligence', NULL, 'arabic natural language mrocessing,natural language processing,artificial intelligence,ai,text analysis,tokenization,stemming,lemmatization,sentiment analysis,machine translation,speech recognition,named entity recognition,chatbot,conversational ai,semantic analysis,part of speech tagging,language modeling,information retrieval,word embeddings,text mining', 'Available', ''),
('amajdah@KSU.EDU.SA', 'Majdah Alshehri', '1', NULL, NULL, 'hci,inclusive technology,design methods,internet of things', 'Available', ''),
('dalsaeed@KSU.EDU.SA', 'Duaa Alsaeed', '1', 'Artificial Intelligence', NULL, 'artificial intelligence,ai,usability,user experience,image processing,recommender systems. ', 'Available', ''),
('eabdulqader@KSU.EDU.SA', 'Ebtisam Alabdulqader', '1', NULL, NULL, 'human computer interaction,internet of things,artificial intelligence,hci,iot,ai', 'Available', ''),
('ealkhamis@KSU.EDU.SA', 'Esra Alkhamis', '1', 'Cybersecurity', NULL, 'usable security,information security, security', 'Available', ''),
('halbaity@KSU.EDU.SA', 'Heyam AlBaity	', '1', NULL, NULL, 'ai,artificial intelligence,data science,machine learning,computer vision,biometrics', 'Available', ''),
('halhindi@KSU.EDU.SA', 'Hanan Alhindi', '1', 'Cybersecurity', NULL, 'Cybersecurity,security', 'Available', ''),
('halsaaran@KSU.EDU.SA', 'Hessah Alsaaran', '1', 'Artificial Intelligence', NULL, 'computer vision,image analysis,video analysis,machine learning,artificial intelligence,ai,ml', 'Available', ''),
('healbassam@KSU.EDU.SA', 'Hend Albassam', '1', NULL, NULL, 'software engineering,user experience design,artificial intelligence,internet of things,iot,ai,swe', 'Available', ''),
('hmokhtar@KSU.EDU.SA', 'Hala Mokhtar', '1', NULL, NULL, 'Internet of Things, Wireless Networks, AI and Machine Learning, Smart Education Systems', 'Available', ''),
('houertani@KSU.EDU.SA', 'Henda Ouertani', '1', 'Artificial Intelligence', NULL, 'artificial intelligence,internet of things,ai,iot', 'Available', ''),
('kalyahya1@KSU.EDU.SA', 'Khulood Alyahya', '1', NULL, NULL, 'artificial intelligence,large language models,optimisation,general machine learning,machine learning in finance,data visualisation,time series forecasting,data science in medical, data science in biological,data science in behavioural,decision making', 'Available', ''),
('ksaleh@KSU.EDU.SA', 'Kholoud AlSaleh', '1', 'Cybersecurity', NULL, 'Searchable encryption,cryptography', 'Available', ''),
('lalbraheem@KSU.EDU.SA', 'Lamia Albraheem', '1', 'Internet of Things', NULL, 'internet of things,vanet,wireless networking,gis,lifi,iot ', 'Available', ''),
('laldubaie@KSU.EDU.SA', 'Lulwa Aldubaie', '1', NULL, NULL, 'natural language processing,nlp', 'Available', ''),
('lalhusain@KSU.EDU.SA', 'Luluah Alhusain', '1', NULL, NULL, 'ml,smart city,smart cities,healthcare,machine learning', 'Available', ''),
('lalsudias@KSU.EDU.SA', 'Lama Alsudias', '1', NULL, NULL, 'natural language processing,data mining\r\narabic applications', 'Available', ''),
('lalzaben@KSU.EDU.SA', 'Lama Alzaben', '1', NULL, NULL, 'natural language processing,nlp,mobile applications,web applications,lifestyle, educational,health,fitness,textual data,machine learning,smart search engines', 'Available', ''),
('maldayel@KSU.EDU.SA', 'Mashael Aldayel	\r\n', '1', 'Artificial Intelligence', NULL, 'artificial intelligence,data science, machine learning,brain computer interface,multidisciplinary,neuro tourism, neuromarketing,emotion recognition,bioinformatics,recommenders system,ai,ds,ml,bci', 'Available', ''),
('malshardan@KSU.EDU.SA', 'Mona Alshardan', '1', NULL, NULL, 'information systems,design thinking,user experience,food trucks ', 'Available', ''),
('nalrumaih@KSU.EDU.SA', 'Nouf Alrumaih', '1', NULL, NULL, 'artificial intelligence,internet of things,ai,iot', 'Available', ''),
('nhakbani@KSU.EDU.SA', 'Noura Hakbani', '1', 'Internet of Things', NULL, 'internet of things,robotics,virtual reality,fitness,rehabilitation,education ', 'Available', ''),
('noralhammad@KSU.EDU.SA', 'Nora Alhammad', '1', NULL, NULL, 'machine learning,artificial intelligence,ml,ai ', 'Available', ''),
('qalsmail@KSU.EDU.SA', 'Qatrunnada Alsmail', '1', 'Cybersecurity', NULL, 'cybersecurity,security', 'Available', ''),
('ralmurshed@KSU.EDU.SA', 'Rana Almurshed', '1', 'Artificial Intelligence', NULL, 'image processing,artificial intelligence,ai', 'Available', ''),
...
('walkaldi@KSU.EDU.SA', 'Wejdan Alkaldi', '1', 'Artificial Intelligence', NULL, 'ai, artificial intelligence,deep learning,nlp,natural language,processing,image processing, reinforcement learning', 'Available', '');
...
INSERT INTO `teams` (`email`, `name`, `password`, `logo`, `draft_ideas`, `supervisor_email`) VALUES
...
--
ALTER TABLE `students`
  ADD CONSTRAINT `FK_teamemail_team` FOREIGN KEY (`team_email`) REFERENCES `teams` (`email`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `supervisor_idea_request`
  ...
  ADD CONSTRAINT `FK_teamemail_team2` FOREIGN KEY (`team_email`) REFERENCES `teams` (`email`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `team_idea_request`
  ...
  ADD CONSTRAINT `FK_teamemail_team1` FOREIGN KEY (`team_email`) REFERENCES `teams` (`email`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
