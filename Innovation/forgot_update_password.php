                ...
                <div class="custom-expanded data-layout-selected u-clearfix u-layout-wrap u-layout-wrap-1">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        ...
                        if (empty($password) || !preg_match("/^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$/", $password)) {
                            echo '<div style="margin-top:5px;padding:5px;border-radius:10px;" class="u-form-send-error u-form-send-message">Password must be at least 8 characters long, contain uppercase, lowercase, a number, and a special character.</div>';
                        } else if ($password !== $reenter_password) {
                            echo '<div style="margin-top:5px;padding:5px;border-radius:10px;" class="u-form-send-error u-form-send-message">Passwords do not match.</div>';
                            ...
                            try {
                                ...
                                $updateStmt->execute();
                                if ($updateStmt) {
                                   echo "<script>alert('Password updated successfully.'); location.replace('LogIn.php')</script>";
                                } else {
                                    echo '<div style="margin-top:5px;padding:5px;border-radius:10px;" class="u-form-send-error u-form-send-message">Your registration has been completed and cannot be updated.</div>';
                                }
                            } catch
                            (PDOException $e) {
                                echo '<div style="margin-top:5px;padding:5px;border-radius:10px;" class="u-form-send-error u-form-send-message">Database error.</div>';
                            }
                        }
                    }
                                    ...
                                    <div class="u-container-style u-group u-opacity u-opacity-30 u-palette-1-light-2 u-radius u-shape-round u-group-2">
                                        <div class="u-container-layout u-container-layout-3">
                                            <div class="u-form u-form-1">
                                                ...
                                                <form ction="<?= 'forgot_update_password.php?email=' . $email . '&type=' . $type ?>"
                                                    ...
                                                    <div class="input-wrapper">
                                                        <label for="M-password"
                                                               class="u-custom-font u-font-georgia u-label">
                                                            New Password <span style="color:red;">*</span>
                                                        </label>
                                                        <input type="password" placeholder="Enter a strong password"
                                                               id="M-password" name="password"
                                                        ...
                                                        <a href="javascript:void(0);"
                                                           onclick="togglePasswordVisibility('M-password')"
                                                           id="toggle-text-1"
                                                    ...
                                                    <div class="u-form-group">
                                                        <label for="M-re-enter-password"
                                                               class="u-custom-font u-font-georgia u-label">
                                                            Re-enter Password <span style="color:red;">*</span>
                                                        </label>
                                                        <input type="password" placeholder="Re-enter password"
                                                               id="M-re-enter-password" name="re-enter-password"
                                                               class="u-border-2 u-border-no-left u-border-no-right u-border-no-top u-border-palette-1-light-1 u-input u-input-rectangle u-none"
                                                               required="required">
                                                        <a href="javascript:void(0);"
                                                           onclick="togglePasswordVisibility('M-re-enter-password')"
                                                           id="text-2"
                                                           style="color: blue; text-decoration: underline; font-size: 12px;">
                                                            Show Password
                                                        </a>
