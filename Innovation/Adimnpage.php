...
<html style="font-size: 16px;" lang="en"><head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="View external requests">
    <meta name="description" content="">
    <title>Adimnpage</title>
    <link rel="stylesheet" href="nicepage2.css" media="screen">
<link rel="stylesheet" href="Adimnpage.css" media="screen">
    ...
    <meta property="og:title" content="Adimnpage">
  ...
  <body data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="en">
    ...
    <section class="u-clearfix u-palette-1-light-1 u-section-1" id="sec-f50a">
                ...
                <div class="u-layout-row">
                  <div class="u-container-style u-layout-cell u-size-60 u-layout-cell-1" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="500">
                    <div class="u-container-layout u-container-layout-2">
                      <h1 class="u-align-center u-text u-text-custom-color-1 u-text-default u-text-1">View external requests</h1>
                      <div class="u-container-style u-group u-opacity u-opacity-30 u-palette-1-light-2 u-radius u-shape-round u-group-2">
                        <div class="u-container-layout u-container-layout-3">
                          <div class="u-form u-form-1">
                            <form action="https://forms.nicepagesrv.com/v2/form/process" class="u-clearfix u-form-spacing-28 u-form-vertical u-inner-form" source="email" name="form" style="padding: 0px;">
                              <div class="u-form-group u-form-name u-label-left u-form-group-1">
                                <label for="name-8e54" class="u-custom-font u-font-georgia u-label u-spacing-10 u-label-1">Name of member name</label>
                                <input type="text" id="name-8e54" name="sname-1" class="u-border-2 u-border-no-left u-border-no-right u-border-no-top u-border-palette-1-light-1 u-input u-input-rectangle u-none" required="">
                              </div>
                              <div class="u-form-group u-label-left u-form-group-2">
                                <label for="email-c6a3" class="u-custom-font u-font-georgia u-label u-spacing-10 u-label-2">Email of member</label>
                                <input type="text" id="email-c6a3" name="semail" class="u-border-2 u-border-no-left u-border-no-right u-border-no-top u-border-palette-1-light-1 u-input u-input-rectangle u-none" required="required" wfd-id="id114">
                              </div>
                              <div class="u-form-group u-label-left u-form-group-3">
                                <label for="text-7c71" class="u-custom-font u-font-georgia u-label u-spacing-10 u-label-3">From which college the request was sent from</label>
                                <input type="text" placeholder="" id="text-7c71" name="text" class="u-border-2 u-border-no-left u-border-no-right u-border-no-top u-border-palette-1-light-1 u-input u-input-rectangle u-none">
                              </div>
                              <div class="u-form-group u-form-textarea u-label-left u-form-group-4">
                                <label for="textarea-e86c" class="u-custom-font u-font-georgia u-label u-spacing-10 u-label-4">The full request</label>
                                <textarea rows="4" cols="50" id="textarea-e86c" name="textarea" class="u-border-2 u-border-no-left u-border-no-right u-border-no-top u-border-palette-1-light-1 u-input u-input-rectangle u-none" required=""></textarea>
                              </div>
                              <div class="u-form-group u-form-submit u-label-left u-form-group-5">
                                <label class="u-label u-spacing-10 u-label-5"></label>
                                <div class="u-align-center u-btn-submit-container">
                                  <a href="#" class="u-active-palette-1-light-3 u-border-none u-btn u-btn-round u-btn-submit u-button-style u-hover-custom-color-6 u-palette-1-dark-1 u-radius u-btn-1">Accept</a>
                                </div>
                          ...
                          <a href="#" class="u-border-none u-btn u-btn-round u-button-style u-hover-custom-color-7 u-radius u-btn-2">REJECT </a>
                        </div>
                      </div>
                    </div>
                  </div>
