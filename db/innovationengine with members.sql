...
--
-- Host: localhost:3306
-- Generation Time: Jan 26, 2025 at 09:28 PM
...
('Norah Alrajhi2', '443200556@student.ksu.edu.sa', '443200556@student.ksu.edu.sa', 1, '$2y$10$DAvRaSuo.fTnRdoQuqwcDOX4IzZQzFt96l8sL1KZNHFXyRz1y8SIS', '1,4', 'fkd'),
('Alhanouf Alshalannn', '443200961@student.ksu.edu.sa', '443200556@student.ksu.edu.sa', 1, '$2y$10$g1ojA4SqUOYA3Vlgh6SsgOWsYYrELO4Tiq7LVUD3hTTMIh.bokH6K', '1,4', 'yeyy');
...
('443200556@student.ksu.edu.sa', 'Norah Alrajhi2', '$2y$10$DAvRaSuo.fTnRdoQuqwcDOX4IzZQzFt96l8sL1KZNHFXyRz1y8SIS', 'uploads/logos/6796a58c38df48.88389258_1d8004362de410cfb49948973f38bae7.jpg', 'ajafri@KSU.EDU.SA');
...
(6, 'StudyBuddy', 'A minimalist app for students to organize study schedules, set reminders for exams, and create flashcards for learning.', 'Rejected', '443200003@student.ksu.edu.sa', 'lalsudias@KSU.EDU.SA', '2024-11-30'),
...
(8, 'dgl', 'lkgifgj', 'Approved', '443200556@student.ksu.edu.sa', 'ajafri@KSU.EDU.SA', '2025-01-26');
