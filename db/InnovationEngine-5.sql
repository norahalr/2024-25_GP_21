...
--
-- Host: localhost:8889
-- Generation Time: Nov 15, 2024 at 10:44 PM
...
(32, 'Faydh', 'Faydh is an Arabic mobile application developed to reduce food waste in Saudi Arabia by connecting individuals and businesses with surplus food to charitable organizations and people in need. The app provides an easy platform for users to donate surplus food, share food waste awareness content, and track their donations. Designed with Saudi Arabia\'s food culture and Vision 2030\'s sustainability goals in mind, Faydh aims to combat food waste and promote a greener future.the app received positive feedback from users for its ease of use and readiness for launch.', 'food waste reduction,surplus food donation,food sharing,sustainable food practices,food awareness,food insecurity,charitable organizations,food banks,environmental sustainability,vision 2030', '-', 'Smart Cities & Environment'),
